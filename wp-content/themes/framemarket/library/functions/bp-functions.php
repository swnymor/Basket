...
require( TEMPLATEPATH . '/buddypress/ajax.php' );
...
function bp_dtheme_enqueue_scripts() {
	...
	wp_enqueue_script( 'dtheme-ajax-js', get_template_directory_uri() . '/buddypress/global.js', array( 'jquery' ), $version );

	// Add words that we need to use in JS to the end of the page so they can be translated and still used.
	$params = array(
		'my_favs'           => __( 'My Favorites', 'framemarket' ),
		'accepted'          => __( 'Accepted', 'framemarket' ),
		'rejected'          => __( 'Rejected', 'framemarket' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'framemarket' ),
		'show_all'          => __( 'Show all', 'framemarket' ),
		'comments'          => __( 'comments', 'framemarket' ),
		'close'             => __( 'Close', 'framemarket' ),
		'view'              => __( 'View', 'framemarket' ),
		'mark_as_fav'	    => __( 'Favorite', 'framemarket' ),
		'remove_fav'	    => __( 'Remove Favorite', 'framemarket' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'framemarket' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
